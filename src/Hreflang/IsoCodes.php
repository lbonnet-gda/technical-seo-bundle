...
/**
 * Generated by tools/generate-iso-codes.php from iso-codes v4.20.1 and the IANA Language Subtag Registry
 * (File-Date 2026-08-08); regenerate rather than edit. Keys are the codes; values are only there for
 * O(1) lookups.
 *
...
final class IsoCodes
{
    ...
    public const LANGUAGES = [
        ...
        'as' => true, 'av' => true, 'ay' => true, 'az' => true, 'ba' => true, 'be' => true, 'bg' => true, 'bi' => true,
        ...
        'sa' => true, 'sc' => true, 'sd' => true, 'se' => true, 'sg' => true, 'sh' => true, 'si' => true, 'sk' => true,
